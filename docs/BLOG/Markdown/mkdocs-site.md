...
template at <https://github.com/liweiook/mkdocs-site>
...
```
$ git remote add origin git@github.com:liweiook/mkdocs-site.git # change to your github repo
$ git branch -M main
...
View your site at <https://liweiook.github.io/mkdocs-site/>.
